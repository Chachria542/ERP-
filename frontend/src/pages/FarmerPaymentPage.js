    ...
    <Layout user={user} onLogout={onLogout}>
      <div className="p-6">
        ...
        <Dialog open={showSuccessModal} onOpenChange={setShowSuccessModal}>
          <DialogContent className="max-w-2xl print-hide-modal">
            <DialogHeader>
            ...
            {savedPayment && (
              <div className="space-y-6 print-modal-content">
                ...
                <div style={{display: 'none'}} className="print-voucher-container">
                    ...
                    <div className="mb-0.5 p-1 border border-gray-400">
                      ...
                      <div className="grid grid-cols-2 gap-1 mt-1 text-[10px]">
                        <div>
                          ...
                          <p className="font-bold text-[10px]">{savedPayment.farmer_name_hindi || savedPayment.farmer_name}</p>
                        </div>
                        <div>
                  ...
                  <div className="border-t-2 border-dashed border-gray-600" style={{margin: '4px 0'}}></div>
