        ...
        for invoice_line in invoice_data.line_items:
            ...
            invoice_doc = {
                ...
                **line_broker_details,
                ...
                "cgst_rate": invoice_line.cgst_rate or 0,
                "cgst_amount": (subtotal * (invoice_line.cgst_rate or 0)) / 100,
                "sgst_rate": invoice_line.sgst_rate or 0,
                "sgst_amount": (subtotal * (invoice_line.sgst_rate or 0)) / 100,
                "igst_rate": invoice_line.igst_rate or 0,
                "igst_amount": (subtotal * (invoice_line.igst_rate or 0)) / 100,
                "freight": 0.0,
                "loading_charges": 0.0,
                "other_charges": 0.0,
                "tcs_applicable": invoice_data.tcs_applicable,
                "tcs_rate": invoice_data.tcs_rate if invoice_data.tcs_applicable else None,
                "tcs_amount": (subtotal * (invoice_data.tcs_rate or 0)) / 100 if invoice_data.tcs_applicable else 0.0,
                "subtotal": subtotal,
                "round_off": round_off,
                ...
                "city_to": invoice_data.city_to,
                "driver_name": invoice_data.driver_name,
                "driver_contact": invoice_data.driver_contact,
                "remarks": invoice_data.remarks,
                "status": "posted",
                "posted_at": datetime.now(timezone.utc).isoformat(),
